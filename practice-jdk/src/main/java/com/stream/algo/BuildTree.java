...
public class BuildTree {
    ...
    public static TreeNode build(int[] preorder, int pre_begin, int pre_end, int[] inorder, int in_begin, int in_end) {
        // 下标都是左闭右开
        ...
        now.left = build(preorder, pre_begin + 1, pre_begin + left_num + 1, inorder, in_begin, target);
